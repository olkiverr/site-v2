...
<header class="site-header">
    <div class="logo-container" style="width: 150px;">
        <img src="/site-v2/img/MangaMuse_White.png" alt="Mangamuse Logo" class="logo-image" style="width: 100%;">
    </div>
        ...
        <div class="sidebar-container" style="display: flex; align-items: center;">
            <div class="search-bar responsive-search-bar">
                ...
                <div id="responsive-user-icon" class="responsive-user-icon" style="margin-left: 15px; position: relative;">
                    <img src="/site-v2/img/icon_user.png" alt="User Icon" class="user-icon" style="width: 30px; height: 30px;" onclick="toggleUserMenu('responsive-user-menu')">
                    <div id="responsive-user-menu" class="user-menu" style="display: none; position: absolute; top: 40px; right: 0; background-color: #333; color: #fff; border-radius: 4px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
                        <?php if (isset($_SESSION['user'])): ?>
                            <a href="/site-v2/pages/account.php" style="display: block; padding: 10px; text-decoration: none; color: #fff;">Account</a>
                            <?php if ($_SESSION['is_admin'] == 1): ?>
                                <a href="/site-v2/pages/admin_panel.php" style="display: block; padding: 10px; text-decoration: none; color: #fff;">Admin Panel</a>
                            <?php endif; ?>
                            <a href="/site-v2/php/logout.php" style="display: block; padding: 10px; text-decoration: none; color: #fff;">Logout</a>
                        <?php else: ?>
                            <a href="/site-v2/pages/login.php" style="display: block; padding: 10px; text-decoration: none; color: #fff;">Login</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="normal-user-icon" style="margin-left: 15px; position: relative;">
        <img src="/site-v2/img/icon_user.png" alt="User Icon" class="user-icon" style="width: 30px; height: 30px;" onclick="toggleUserMenu('normal-user-menu')">
...
<script src="/site-v2/js/header.js"></script>
